...
class SolutionQuickSelect {
    ...
    /**
     * @return The frequency of the kth largest element. (must ensure: 0 <= k <
     *     frequencyPairs.size()).
     */
    ...
    /**
     * @param lowerBound the min index to include (inclusive).
     * @param upperBound the max index to include (inclusive).
